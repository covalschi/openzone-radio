// Forward every hid.dll export to the real one in System32.
//
// This DLL exists to be loaded, not to be a HID library: the server imports
// hid.dll and keeps no copy of its own beside the executable, so a file with
