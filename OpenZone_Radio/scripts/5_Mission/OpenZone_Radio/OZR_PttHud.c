...
class OZR_PttHud
{
    ...
    static void Set(int mode)
    {
        ...
        // КОЛЬОРИ ЖИВУТЬ У РОЗКЛАДЦІ. Тут стояли чотири SetColor, які на
        // кожній зміні режиму перефарбовували те, що ozr_ptt.layout уже
        // оголосив -- тобто авторські кольори з розкладки не було видно
        // жодного разу, і правити їх довелося б у скрипті. Підкладка темна й
        // напівпрозора, іконка й підпис білі: біле по світлому небу або по
        // снігу інакше не читається взагалі.
