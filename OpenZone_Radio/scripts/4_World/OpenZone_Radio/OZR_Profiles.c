...
class OZR_Profiles : OZ_ConfigBase
{
    ...
    // Типово -- п'ять рацій, які мод приносить із собою.
    //
    // Кроки всі кратні 0.0125, тобто кроку сітки: рація з некратним кроком
    // стала б МІЖ діленнями сітки й не зійшлася б ні з ким. Межі теж лежать на
    // діленнях.
    //
    // Перетини навмисне неповні. 100-метрова і 200-метрова сходяться лише на
    // 145..146 -- домовитись можуть, але не будь-де.
