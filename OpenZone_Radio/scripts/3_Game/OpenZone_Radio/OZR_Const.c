...
class OZR_Const
{
    ...
    // створювати САМИМ.
    //
    // Раніше його не створював ніхто: єдиний, хто це робив, -- ядро
    // (OZ_Json.EnsureTree), а ядра рація свідомо не вимагає. На сервері з
    // одним лише @OpenZone_Radio жоден Save не вдавався взагалі: FPrintln і
    // JsonFileLoader у неіснуючий каталог просто не пишуть. Тобто мод, який
    // обіцяє працювати сам по собі, мовчки не зберігав ані налаштувань, ані
    // профілів, ані виведеної сітки -- і саме остання робить ефір широким.
    //
    ...
    // Відповідь сервера на настройку -- лише відмови, ключем таблиці рядків
    // (D103): мовчазна відмова виглядала як зламана клавіатура.
    static const string RPC_TUNE_RES = "OZR_TuneRes";
